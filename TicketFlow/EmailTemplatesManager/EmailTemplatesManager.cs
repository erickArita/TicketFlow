...
public static class EmailTemplatesManager
{
    ...
    {
        var archivo = @"<!DOCTYPE html PUBLIC ""-//W3C//DTD XHTML 1.0 Transitional//EN""
                                                        ...
                                                        <tr>
                                                            <td align=""center"" class=""esd-block-image""
                                                                style=""font-size: 0px;""><a target=""_blank""><img
                                                                    ...
                                                                    alt style=""display: block;"" width=""600""></a></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                ...
                <table cellpadding=""0"" cellspacing=""0"" class=""es-content esd-footer-popover"" align=""center"">
                    ...
                    <tr>
                        <td class=""esd-stripe"" align=""center"" bgcolor=""#071f4f""
                            ...
                            <table bgcolor=""#071f4f"" class=""es-content-body"" align=""center"" cellpadding=""0""
                                   cellspacing=""0"" width=""600"">
                                <tbody>
                                <tr>
                                                    ...
                                                    <table cellpadding=""0"" cellspacing=""0"" width=""100%"">
                                                        ...
                                                        <tr>
                                                            <td align=""center"" class=""esd-block-text es-p10t es-p10b"">
                                                                <p style=""color: #ffffff;"">{{Descripcion}}</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align=""left"" class=""esd-block-text"">
                                                                <p style=""color: #ffffff; font-size: 11px; margin-left: 20px;"">
                                                                    {{Fecha}}</p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
