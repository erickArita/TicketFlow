...
public interface ITicketService
{
    ...
    public Task<RespuestaResponse> AddResponseAsync(Guid ticketId, CreateResponseRequest respuestaCreationDto);
    public Task<RespuestaResponse> UpdateResponseAsync(Guid respuestaId, UpdateResponseRequest respuestaUpdateDto);
}